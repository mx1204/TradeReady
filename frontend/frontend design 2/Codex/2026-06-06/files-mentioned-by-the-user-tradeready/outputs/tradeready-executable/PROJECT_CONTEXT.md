...
6. Seller describes the product in their own words.
7. AI agent classifies the product, for example `iphone17 product` -> `Mobile phone`.
8. AI checks certificate and requirement needs.
...
- After country click, do not create an extra collapsed details container. Only keep the selected country card highlighted and show `Show details` plus `Next`.
...
- Real product classification from seller natural-language description.
- Real form filling.
- Real PDF generation.
